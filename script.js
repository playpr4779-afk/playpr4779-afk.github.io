...
const programDetails = {
  ...
  "ai-video": {
    ...
    items: [
      ...
      ["시상계획", "시상 규모 보기"],
      ["문의", "경남미디어콘텐츠협동조합 / 055-230-1419 / bskim@masan.ac.kr"],
    ],
  },
  webtoon: {
    eyebrow: "WEBTOON",
    ...
    groups: [
      {
        ...
        rows: [
          ...
          ["경상남도교육감상", "1명", "최우수상"],
          ["경남문화예술진흥원장상", "2명", "우수상"],
          ["영산대학교 경남RISE사업단장상", "2명", "장려상"],
          ["영산대학교 와이즈인재개발원장상", "2명", "미래인재상"],
          ["(사)경남콘텐츠산업협회장상", "2명", "콘텐츠인재상"],
        ],
      },
      {
        label: "REX-CUBE 팀전",
        rows: [
          ["영산대학교 총장상", "1팀", "대상"],
          ["영산대학교 경남RISE사업단장상", "2팀", "최우수상"],
          ["영산대학교 와이즈인재개발원장상", "2팀", "우수상"],
          ["영산대학교 드론공간정보공학과 학과장상", "2팀", "장려상"],
          ["(사)경남콘텐츠산업협회장상", "2팀", "팀워크상"],
          ["(사)경남드론협회장상", "3팀", "전략상"],
          ["(주)코코드론 대표이사상", "3팀", "드론챌린지상"],
        ],
      },
    ],
  },
